...
unset($__errorArgs, $__bag); ?>" type="text" id="validationServer01" name="firstName" id="firstName" value="<?php echo e(old('firstName')); ?>" placeholder="Enter First Name">
...
unset($__errorArgs, $__bag); ?>" type="text" id="validationServer02" type="text" name="lastName" id="lastName" value="<?php echo e(old('lastName')); ?>" placeholder="Enter Last Name">
...
unset($__errorArgs, $__bag); ?>" type="text" id="validationServer03" type="text" name="email" id="email" value="<?php echo e(old('email')); ?>" placeholder="Enter Email">
...
unset($__errorArgs, $__bag); ?>" type="text" id="validationServer04" type="text" name="age" id="age" value="<?php echo e(old('age')); ?>" placeholder="Enter Age">
                        <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php /**PATH C:\Users\shawn\praktikmodul4\resources\views/employee/create.blade.php ENDPATH**/ ?>